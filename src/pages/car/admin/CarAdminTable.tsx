...
function CarAdminTable({ carList, setCarList, isLoading = false, reload }: CarTableProps) {
              ...
              <Table className="w-full" style={{ tableLayout: 'fixed' }}>
                <TableHeader className="bg-gradient-to-r from-gray-50 to-gray-100">
                  <TableRow className="[&>th]:px-4 [&>th]:py-3 border-b border-gray-200">
                    ...
                    <TableHead className="text-gray-600 font-medium" style={{ width: '16px' }}>연식</TableHead>
                    <TableHead className="text-gray-600 font-medium" style={{ width: '32px' }}>업체명</TableHead>
              ...
              <TableBody>
                ...
                {carList.map((car, idx) => (
                  ...
                  >
                    ...
                    <TableCell style={{ width: '16px' }} className="text-gray-700">
                      <span onClick={(e) => e.stopPropagation()}>{car.carYear}</span>
                    </TableCell>
                    <TableCell style={{ width: '32px' }} className="text-gray-700">
                      <span onClick={(e) => e.stopPropagation()}>{car.bizName}</span>
                    </TableCell>
