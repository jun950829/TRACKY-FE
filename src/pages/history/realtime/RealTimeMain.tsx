...
import RealTimeDrivePanel from "./RealTimeDrivePanel";
        ...
        <div className="relative w-[360px] p-3">
          ...
          {selectedCarNumber ? (
            <RealTimeDrivePanel
              ...
              onToggle={() => setSelectedCarNumber(null)} // 뒤로가기 시 검색창으로
            />
          ) : (
            <RealTimeSearchPanel
              onToggle={() => setIsSearchOpen(false)}
              onSelectCarNumber={(carNumber) => setSelectedCarNumber(carNumber)}
            />
          )}
        </div>
      </div>
