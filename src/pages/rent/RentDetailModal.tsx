            ...
            <CardContent className="p-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="font-medium">{rentData.purpose}</div>
                </div>
                <div className="space-y-2">
                  <div className="text-sm text-zinc-500 flex items-center gap-2">
                    <FileText className="h-4 w-4" />
                  ...
                  <div className="font-medium">{getStatusLabel(rentData.rentStatus.toLowerCase())}</div>
                </div>
                <div className="space-y-2">
                  <div className="text-sm text-zinc-500 flex items-center gap-2">
                  ...
                  <div className="font-medium">{formatDateTime(rentData.rentStime)}</div>
                </div>
                <div className="space-y-2">
                  <div className="text-sm text-zinc-500 flex items-center gap-2">
                    <Calendar className="h-4 w-4" />
                  ...
                  <div className="font-medium">{formatDateTime(rentData.rentEtime)}</div>
                </div>
                <div className="space-y-2">
                  <div className="text-sm text-zinc-500 flex items-center gap-2">
                  ...
                  <div className="font-medium">{rentData.rentLoc}</div>
                </div>
                <div className="space-y-2">
                  <div className="text-sm text-zinc-500 flex items-center gap-2">
                    <MapPin className="h-4 w-4" />
                  ...
                  <div className="font-medium">{rentData.returnLoc}</div>
                </div>
              </div>
            </CardContent>
          </Card>
